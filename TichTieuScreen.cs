...
{
	// Token: 0x06000F8F RID: 3983 RVA: 0x0012A9A0 File Offset: 0x00128BA0
	public TichTieuScreen(mVector vec, int ruby) : base(0, vec, T.tichTieuRuby, 200, 180)
	{
		this.rubyDaNap = ruby;
	...
	// Token: 0x06000F90 RID: 3984 RVA: 0x0012AC54 File Offset: 0x00128E54
	...
	// Token: 0x06000F91 RID: 3985 RVA: 0x0012AC90 File Offset: 0x00128E90
	public override void commandPointer(int index, int subIndex)
	{
		...
		case 7:
		{
			...
			TichTieuInfo.instance = new TichTieuInfo(this.type, mem);
	...
	// Token: 0x06000F92 RID: 3986 RVA: 0x0000C938 File Offset: 0x0000AB38
	...
	// Token: 0x06000F93 RID: 3987 RVA: 0x0012AD80 File Offset: 0x00128F80
	...
	// Token: 0x06000F94 RID: 3988 RVA: 0x0012AE14 File Offset: 0x00129014
	...
	// Token: 0x06000F95 RID: 3989 RVA: 0x0012B09C File Offset: 0x0012929C
	...
	// Token: 0x06000F96 RID: 3990 RVA: 0x0000B79D File Offset: 0x0000999D
	...
	// Token: 0x06000F97 RID: 3991 RVA: 0x0012B2AC File Offset: 0x001294AC
	public override void paintBg(mGraphics g)
	{
		...
		AvMain.FontBorderColor(g, T.ruby + " :", this.xSub + this.wSub / 2 - 2, this.ySub + 37, 1, 1, 7);
		mFont.tahoma_7b_black.drawString(g, Interface_Game.ConvertNumToStr(this.rubyDaNap), this.xSub + this.wSub / 2 + 2, this.ySub + 38, 0);
	}

	// Token: 0x06000F98 RID: 3992 RVA: 0x0012B3A4 File Offset: 0x001295A4
	...
	// Token: 0x06000F99 RID: 3993 RVA: 0x0012B418 File Offset: 0x00129618
	...
	// Token: 0x06000F9A RID: 3994 RVA: 0x000D9530 File Offset: 0x000D7730
