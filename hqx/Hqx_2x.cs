...
namespace hqx
{
	...
	{
		// Token: 0x06000FF6 RID: 4086 RVA: 0x00131DD4 File Offset: 0x0012FFD4
		public static void hq2x_32_rb(int[] sp, int[] dp, int Xres, int Yres)
		{
			Hqx_2x.hq2x_32_rb(sp, dp, Xres, Yres, 48, 7, 6, 0, false, false);
		}

		// Token: 0x06000FF7 RID: 4087 RVA: 0x00131DF4 File Offset: 0x0012FFF4
